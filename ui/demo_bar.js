...
(function () {
  ...
  var ROLES = [
    { id: 'business', label: 'Business user', can: ['assistant.use'] },
    { id: 'analyst', label: 'Analyst', can: ['data.view', 'recompute.run', 'policy.propose', 'assistant.use'] },
    { id: 'approver', label: 'Risk approver', can: ['data.view', 'audit.view', 'recompute.run', 'policy.approve', 'assumptions.change', 'assistant.use'] },
